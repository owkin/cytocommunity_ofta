## Hyperparameter
InputFolderName = "/home/owkin/project/cytocommunity_results/unsupervised/chuv/"


Sys.time()
#Create an outer folder to collect all images.
ThisStep_OutputFolderName <- "/home/owkin/project/cytocommunity_results/unsupervised/2024-11-06_10-17-29/ensemble"
...
dirs <- list.dirs("/home/owkin/project/cytocommunity_results/unsupervised/2024-11-06_10-17-29/crossval", recursive = TRUE)
