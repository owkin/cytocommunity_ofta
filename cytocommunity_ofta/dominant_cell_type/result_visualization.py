...
def result_visualization(Image_Name, timestamp):
    ## Hyperparameters
    ...
    unique_cell_type_df = pd.read_csv(
            "/home/owkin/project/cytocommunity_results/dominant_cell_type/graphs/neighbors_order_1/UniqueCellTypeList.txt",
            sep="\t",  # tab-separated
    ...
    print('cell_type_label', cell_type_label)
    ...
    print("target_graph_map.shape", target_graph_map.shape)
    
    
    ## Import the final TCN labels to target graph x/y coordinates.
    LastStep_OutputFolderName = "/home/owkin/project/cytocommunity_results/dominant_cell_type/experiments/" + Image_Name + "/" + timestamp + "/ensemble/"
    ...
    #-----------------------------------------Generate plots-------------------------------------------------#
    ThisStep_OutputFolderName = "/home/owkin/project/cytocommunity_results/dominant_cell_type/experiments/" + Image_Name + "/" + timestamp + "/result_visualization/"
