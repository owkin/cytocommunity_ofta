...
ThisStep_OutputFolderName <- paste0("/home/owkin/project/cytocommunity_results/dominant_cell_type/supervised/experiments/", timestamp, "/ensemble")
...
dirs <- list.dirs(paste0("/home/owkin/project/cytocommunity_results/dominant_cell_type/supervised/experiments/", timestamp, "/crossval"), recursive = TRUE)
