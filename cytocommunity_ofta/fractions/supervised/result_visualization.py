...
def result_visualization(timestamp):
    ...
    ThisStep_OutputFolderName = f"/home/owkin/project/cytocommunity_results/fractions/supervised/experiments/{timestamp}/result_visualization/"
    ...
    LastStep_OutputFolderName = f"/home/owkin/project/cytocommunity_results/fractions/supervised/experiments/{timestamp}/ensemble/"
