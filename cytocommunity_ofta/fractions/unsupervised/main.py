from cytocommunity_ofta.fractions.unsupervised.tcnlearning_unsupervised import tcn_learning_unsupervised
from cytocommunity_ofta.fractions.unsupervised.result_visualization import result_visualization
import subprocess
import yaml
...
InputFolderName = graph["InputFolderName"]
...
for Image_Name in Image_Name_All:
    ...
    timestamp = tcn_learning_unsupervised(Image_Name, InputFolderName)
    ...
    result_visualization(Image_Name, timestamp, InputFolderName)