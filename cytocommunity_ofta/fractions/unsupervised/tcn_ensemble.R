...
#Import data.
LastStep_OutputFolderName <- paste0("/home/owkin/project/cytocommunity_results/fractions/experiments/", Image_Name, "/", timestamp, "/crossval/")
...
ThisStep_OutputFolderName <- paste0("/home/owkin/project/cytocommunity_results/fractions/experiments/", Image_Name, "/", timestamp, "/ensemble/")
